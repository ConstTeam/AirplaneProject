...
export default class Background extends Laya.Script
{
	...
	{
		var _$this = this;
		if(_$this._curGround.x <= -2038)
		{
			_$this._curGround.x = 2456 + 2038 + _$this._curGround.x;
		...
		if(_$this._curMountains.x <= -3132)
		{
			_$this._curMountains.x = 3000 + 3132 + _$this._curMountains.x;
		...
		if(_$this._curCloud.x <= -3434)
		{
			_$this._curCloud.x = 3154 + 3432 + _$this._curCloud.x;
