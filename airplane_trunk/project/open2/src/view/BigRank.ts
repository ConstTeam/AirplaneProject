...
export default class BigRank extends ui.test.BigUI{
        ...
        {index:5,avatarIP:'test/4.png',UserName:"测试用户4",RankValue:25},
        {index:6,avatarIP:'test/4.png',UserName:"测试用户4",RankValue:25},
        {index:7,avatarIP:'test/4.png',UserName:"测试用户4",RankValue:25}
        ]
